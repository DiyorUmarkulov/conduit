...
class CircuitBreakerState {
  ...
  public constructor(private readonly now: () => number, options: CircuitBreakerOptions = {}) {
  ...
  public beforeExecution(): void {
    ...
    if (this.state === "HALF_OPEN") {
      if (this.halfOpenCalls >= this.halfOpenMaxCalls) {
        throw new CircuitBreakerOpenError("Circuit breaker is half-open and saturated");
      }
...
export class DispatchResilience {
  ...
  public constructor(private readonly options: DispatchResilienceOptions = {}) {
    ...
    this.circuitBreaker = new CircuitBreakerState(this.now, options.circuit_breaker);
  }
