...
export interface NatsCoreProviderOptions {
...
export const NATS_CORE_PROVIDER_NAME = "NATS" as const;
export const NATS_PROVIDER_NAME = NATS_CORE_PROVIDER_NAME;
...
export class NatsCoreProvider implements ITransportProvider {
  public readonly name = NATS_CORE_PROVIDER_NAME;
  ...
  public constructor(
    ...
    private readonly options: NatsCoreProviderOptions = {}
  ) {
    this.resolveSubject =
...
export type NatsProviderOptions = NatsCoreProviderOptions;
export class NatsProvider extends NatsCoreProvider {}
